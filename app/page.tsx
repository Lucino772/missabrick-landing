        ...
        <>
            <div className="flex h-full min-h-0 w-full min-w-0 flex-col">
                <div className="animate-hero-zoom-in relative h-screen w-full flex-1 overflow-hidden opacity-0">
                    ...
                    />
                    <div className="absolute inset-7.5 flex animate-[800ms_ease-in-out_1s_forwards_fade-in] flex-col items-center justify-center gap-5 rounded-xl bg-black/5 opacity-0">
                        <h1 className="font-title max-w-200 text-center text-7xl text-black">
                            Never miss a brick. Every piece accounted for.
                        </h1>
                        <div className="border/60 flex w-full max-w-125 flex-row items-center gap-3 rounded-md bg-white px-2.5 pt-2 pb-1 text-black shadow">
            ...
            <section className="h-500">Hello World !</section>
        </>
    );
}
